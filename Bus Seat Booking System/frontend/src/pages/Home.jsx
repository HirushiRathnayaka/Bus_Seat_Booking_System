        ...
        <div className="hero-panel">
          <div className="hero-content">
            <div className="hero-badges">
              <span className="summary-pill">Fast booking</span>
              <span className="summary-pill">Seat security</span>
            </div>
            <h1 className="page-title">
              <span className="title-text">Bus Seat Booking System</span>
            </h1>
            <p className="page-subtitle">Choose a route and reserve your seat in minutes.</p>
          </div>

          <div className="hero-actions">
            <div className="route-count">{routes.length} routes available</div>
            <button
              className="btn-ghost"
